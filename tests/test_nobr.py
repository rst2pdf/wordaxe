...
"""
This is a modification of test_frames3b.py.
The word "Bedauerlicherweise" is enclosed in a <nobr> tag.
"""
...
class NoBrTestCase(unittest.TestCase):
    "Test hyphenation with nobr tags in paragraphs."
    ...
    def test(self):    
        ...
        text = "<nobr>Bedauerlicherweise</nobr> ist ein Donaudampfschiffkapitän auch nur ein Dampfschiffkapitän."
        ...
        doc = TwoColumnDocTemplate("test_nobr.pdf", pagesize=PAGESIZE)
        doc.build(story)
